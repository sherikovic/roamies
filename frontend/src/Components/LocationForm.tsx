...
const LocationForm: React.FC<LocationFormProps> = (props) => {
    const [formErrors, setFormErrors] = useState({ name: "", latitude: "", description: "" });
    ...
    const validateFormInputs = (FormData: any) => {
        ...
        FormData.latitude === "" ?
            setFormErrors(prev => ({ ...prev, latitude: "Latitude is required!" })) :
    ...
    return (
        <div className={classes.card_container}>
            ...
            <form method={props.method} className={classes.form} onSubmit={submitHandler}>
                ...
                <p>
                    ...
                    <textarea
                        ...
                        cols={30}
                        rows={3}
                        defaultValue={props.LocationData ? props.LocationData.description : ""}
                    />
                </p>
