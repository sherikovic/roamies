...
export default function Download() {
  return (
    <div className="relative flex flex-col items-center justify-center py-32 px-6 bg-gradient-to-b from-[#e7f0fc] to-white">
      <p className="poppins-semibold text-textPrimary text-center lg:text-4xl mb-4">
