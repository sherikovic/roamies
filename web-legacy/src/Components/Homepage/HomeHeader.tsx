...
const HomeNavigation: React.FC = () => {
  const [searchPlaceholder, setSearchPlaceholder] = useState('Search for Events')
  ...
  return (
    <HomeNavBar>
      <HomeNavBarSide>
        ...
        <SearchField>
          <SearchFilterBtn type="button" onClick={filterBtnOnClick} ref={filterDDRef}>
            {filterBtnText}
            <DropDownImg
          ...
          <label htmlFor="search">
            <Img
              ...
              $left={540}
              $mr={8}
              style={hideSearchIcon ? { display: 'none' } : { display: 'block' }}
            />
          </label>
          <input
            type="search"
